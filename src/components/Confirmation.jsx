    ...
    return (
      <div className="div-body">
        <div className="confirmation-page">
          ...
          <button className="confirmation-btn" onClick={() => navigate('/movie')}>
            Back to Movies
          </button>
        </div>
      </div>
    ...
    <div className="div-body">
      <div className="confirmation-profile-bar">
        <div className="confirmation-profile-details">
          ...
          {user?.email && (
            <span className="confirmation-profile-email">({user.email})</span>
          )}
          <button className="confirmation-logout-btn" onClick={handleLogout}>
            Log out
          </button>
        </div>
      </div>
      ...
      <div className="confirmation-page">
        ...
        <div className="confirmation-details">
          ...
          <div><b>Movie:</b> {booking.movie}</div>
          ...
          <div><b>Net Payment:</b> ₹{Number(booking.totalAmount).toFixed(2)}</div>
        </div>
        <button className="confirmation-btn" onClick={() => navigate('/movie')}>
          Return to Movies
        </button>
